...
export interface DiscordConfig {
  ...
  channelProjects: Record<string, string>; // channelId → absolute project directory path
}
  ...
  return {
    ...
    discord: {
      ...
      listenChannels: Array.isArray(raw.discord?.listenChannels)
        ...
        : [],
      channelProjects: (raw.discord?.channelProjects && typeof raw.discord.channelProjects === "object")
        ? raw.discord.channelProjects
        : {},
    },
    security: {
      level,
